...
<head>
    ...
    <title> SScharacters @yield('title') </title>
    <link rel="shortcut icon" href="/image/saint_seiya.png">
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <img src="/image/saint_seiya.png" alt="saint seiya" width="50rem" height="30rem">
                </a>
